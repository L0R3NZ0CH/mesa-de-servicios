...
class TechnicianController {
  async create(req, res) {
    try {
      const { email, password, first_name, last_name, phone, department, specialty, schedule_start, schedule_end, max_tickets } = req.body;
  ...
  async update(req, res) {
    try {
      ...
      const updatedTechnician = await Technician.update(req.params.id, req.body);
  ...
  async getPerformance(req, res) {
    try {
      ...
      const performance = await Technician.getPerformance(req.params.id, dateFrom, dateTo);
